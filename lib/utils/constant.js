...
export const NAVER_MAP_GEOCODE_URL = `https://naveropenapi.apigw.ntruss.com/map-geocode/v2/geocode`;

export const KAKAO_MAP_URL = `https://dapi.kakao.com/v2/local/search/keyword.json`;

export const NAVER_MAP_STANDARD = 55;
...
export const FIRST_GUIDE_MESSAGE = (
  <div style={{ padding: "10px 20px" }}>
    마침반의 공적마스크 재고 정보는 건강보험심사평가원에서 제공하는 공공데이터를
    바탕으로 합니다. 판매처별로 시행되는 번호표 배부, 대기줄의 상황은 반영되지
    않기 때문에 현장의 실제 재고 수량과 다를 수 있으니 참고 부탁드립니다.
  </div>
);
